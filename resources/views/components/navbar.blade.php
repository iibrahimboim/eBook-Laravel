    ...
    <div class="container-xl">
        ...
        <!-- BEGIN NAVBAR LOGO --><a href="../../.." aria-label="Tabler"
            ...
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTOCvNa3r_hszq7pPtvOQKKYOepdqMsD5tJapqoyZoiAA&s=10"
                width="50" height="32" class="navbar-brand-logo">
            <path
        ...
        <ul class="navbar-nav mx-auto w-50">
            <div class="dropdown mt-2">
                <a href="#" class="nav-link dropdown-toggle pt-2 ee-2" data-bs-toggle="dropdown">Kategori</a>
                <div class="dropdown-menu dropdown-menu-card" style="min-width: 600px">
                    <div class="p-3">
                        <div class="row g-2">
                            ...
                            <div class="col-3">
                                <div class="card py-3">
                                    <div class="card-body p-2 text-center">Kategori 5</div>
                                </div>
                            </div>

                            <div class="col-3">
                                <div class="card py-3">
                                    <div class="card-body p-2 text-center">Kategori 6</div>
                                </div>
                            </div>

                            <div class="col-3">
                                <div class="card py-3">
                                    <div class="card-body p-2 text-center">Kategori 7</div>
                                </div>
                            </div>

                            <div class="col-3">
                                <div class="card py-3">
                                    <div class="card-body p-2 text-center">Kategori 8</div>
                                </div>
                            </div>
